package cn.dianshi.controller.admin;
...
import cn.dianshi.service.TagService;
...
public class BlogController {
    ...
    public String searchBlogs(@PageableDefault(size = 5, sort = {"updateTime"}, direction = Sort.Direction.DESC) Pageable pageable, BlogQuery blog, Model model){
        model.addAttribute("page",blogService.listBlog(pageable, blog));
